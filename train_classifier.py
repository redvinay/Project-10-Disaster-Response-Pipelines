...
def load_data(database_filepath):
    '''
    To load the database from the given filepath and process them as X, y and category_names
...
def evaluate_model(model, X_test, Y_test, category_names):
    '''
    To evaluate a model and return the classificatio and accurancy score.
    Inputs: Model, X_test, y_test, Catgegory_names
    Outputs: To print the Classification report & Accuracy Score
    '''
...
def save_model(model, model_filepath):
    ...
    Output: To save the model as pickle file in the give filepath 
    '''
